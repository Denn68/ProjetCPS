        ...
        this.runTask(new AbstractComponent.AbstractTask() {
            ...
            public void run() {
                try {
        			...
        			ContentDataI oldPerson1 = ((Client2) this.getTaskOwner()).put(key1, data1);
        			...
        			ContentDataI oldPerson2 = ((Client2) this.getTaskOwner()).put(key2, data2);
        			...
        			ContentDataI oldPerson3 = ((Client2) this.getTaskOwner()).put(key3, data3);
        			...
        			ContentDataI oldPerson4 = ((Client2) this.getTaskOwner()).put(key4, data4);
        			...
        			ContentDataI oldPerson5 = ((Client2) this.getTaskOwner()).put(key5, data5);
        			System.out.println(((Client2) this.getTaskOwner()).get(key5).getValue(attNOM));
                    System.out.println(((Client2) this.getTaskOwner()).get(key5).getValue(attAGE));
        			assert oldPerson5 == null : "Type incorrect";
        			assert ((Client2) this.getTaskOwner()).get(key5).getValue(attNOM).equals(P5_nom) : "Nom incorrect";
        			assert ((Client2) this.getTaskOwner()).get(key5).getValue(attAGE).equals(P5_age) : "Age incorrect";

        			ContentDataI oldPerson6 = ((Client2) this.getTaskOwner()).put(key6, data6);
