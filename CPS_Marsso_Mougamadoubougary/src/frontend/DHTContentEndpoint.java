...
public class DHTContentEndpoint 
extends BCMEndPoint<ContentAccessSyncCI>{

	public DHTContentEndpoint() {
		super(ContentAccessSyncCI.class, DHTServicesCI.class);
	}
	...
	protected AbstractInboundPort makeInboundPort(AbstractComponent c, String inboundPortURI) throws Exception {
		...
		// Invariant checking
		assert	DHTContentEndpoint.implementationInvariants(this) :
				new ImplementationInvariantException(
						"DHTEndpoint.implementationInvariants(this)");
		assert	DHTContentEndpoint.invariants(this) :
