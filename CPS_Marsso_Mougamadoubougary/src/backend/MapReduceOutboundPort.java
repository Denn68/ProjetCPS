...
public class MapReduceOutboundPort extends AbstractOutboundPort implements MapReduceCI {

    private static final long serialVersionUID = 1L;

    // Constructeur par défaut pour MapReduce
    public MapReduceOutboundPort(ComponentI owner) throws Exception {
        super(MapReduceCI.class, owner);
    }

    // Constructeur personnalisé avec interface requise
    protected MapReduceOutboundPort(Class<? extends RequiredCI> implementedInterface, ComponentI owner) throws Exception {
        super(implementedInterface, owner);
    }

    // Lance une opération map de manière synchrone via le connecteur
    @Override
    ...
    // Lance une opération reduce de manière synchrone via le connecteur
    @Override
    ...
    // Lance une opération map de manière asynchrone via le connecteur
    @Override
    ...
    // Lance une opération reduce de manière asynchrone via le connecteur
    @Override
