...
extends AbstractCVM{
	...
	public void deploy() throws Exception{
		...
		AbstractComponent.createComponent(Node.class.getCanonicalName(), new Object[] {
				0, 1, 0, 399, ((CompositeEndPoint) ep2.copyWithSharable()), ((CompositeEndPoint)ep3.copyWithSharable())});
		AbstractComponent.createComponent(Node.class.getCanonicalName(), new Object[] {
				0, 1, 0, 399, ((CompositeEndPoint) ep3.copyWithSharable()), ((CompositeEndPoint)ep2.copyWithSharable())});
		...
		AbstractComponent.createComponent(Facade.class.getCanonicalName(), new Object[] {
				0, 1, ((DHTServicesEndpoint) ep1.copyWithSharable()), ((CompositeEndPoint)ep2.copyWithSharable())});
		AbstractComponent.createComponent(Client.class.getCanonicalName(), new Object[] {
				0, 1, ((DHTServicesEndpoint) ep1.copyWithSharable())});
		super.deploy();
	}
